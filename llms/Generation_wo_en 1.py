...
Highlight the events that shaped {possessive} legacy and discuss {possessive} impact on society."""
        ...
        self.base_prompt_old = """Write a detailed and vivid paragraph in {language} about a completely fictional character with a made-up name, who {present_tense} {fame} {gender} figure {era} and {present_tense} a {role}. 
...
output_csv_file_path = f"{model_n}_{language}_wo_names.csv"
