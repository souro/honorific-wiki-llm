...
language = "bengali"
translate_file = f"Results/{model_n}_english_{language}_w_names.csv"
...
Highlight the events that shaped {possessive} legacy and discuss {possessive} impact on society."""
        ...
        self.base_prompt_old = """The following is a detailed and vivid paragraph in {language} about {name}. Translate the paragraph into {language}.
...
INTERVAL = 30  # Wait time between requests (in seconds)
...
output_csv_file_path = f"Translated_{model_n}_w_names.csv"
